    ...
    public class TasksController : ApiController
    {
        ...
        public object[] Get()
        {
            ...
            return new object[] { new { Id = 1, Name = "Email, planning, and time tracking", Status="Stopped", Tags=new string[]{}, Description="This is the description.", Active=false},
                                  new { Id = 2,Name = "Sales support", Status="New", Tags=new string[]{}, Description="What good is a reward if you ain't around to use it? Besides, attacking that battle station ain't my idea of courage. It's more like…suicide. All right.", Active=true},
